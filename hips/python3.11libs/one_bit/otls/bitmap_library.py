...
def library_to_pts(hda_node, node, frame=None):
    ...
    bitmap_atr = geo.addAttrib(hou.attribType.Point, "bitmap", "", create_local_variable=False)
    res_atr = geo.addAttrib(hou.attribType.Point, "res", [0,0], create_local_variable=False)
    static_atr = geo.addAttrib(hou.attribType.Point, "static", 1, create_local_variable=False)
    start_atr = geo.addAttrib(hou.attribType.Point, "start_frame", 0, create_local_variable=False)
    end_atr = geo.addAttrib(hou.attribType.Point, "end_frame", 0, create_local_variable=False)
    mask_atr = geo.addAttrib(hou.attribType.Point, "has_mask", 0, create_local_variable=False)
